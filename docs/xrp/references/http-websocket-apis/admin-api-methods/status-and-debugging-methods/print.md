---
title: print
seoTitle: Print Command Overview - Rippled
sidebar_position: 4
description: İçsel alt sistemlerin durumu hakkında kapsamlı bilgi edinmek için print komutunu kullanabilirsiniz. Bu döküman, komutun kullanılabilirliğini, istek formatını ve yanıt formatını detaylandırmaktadır.
tags: 
  - print
  - rippled
  - içsel alt sistemler
...
`print` komutu, akranlar, defter temizleyici ve kaynak yöneticisi gibi çeşitli içsel alt sistemlerin mevcut durumunu döndürür.

> *`print` yöntemi, yetkisiz kullanıcılar tarafından çalıştırılamayan bir `admin yöntemi`dir!* — 
...
Yanıt, [standart formata][] uyar. Sonuçtaki ek alanlar, `rippled` sunucusunun içsel durumuna bağlıdır. Bu komutun sonuçları, bildirim yapılmaksızın değişebilir.
...
:::info
Hayal edebileceğiniz tüm hata türlerini kontrol edin ve uygun çözümleri uygulayın.
:::
