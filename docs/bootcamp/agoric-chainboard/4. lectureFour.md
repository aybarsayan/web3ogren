...
### Türetilmiş erights
`Türetilmiş eright`ın ne olduğunu ve nasıl kullanabileceğimizi anlamak için, İkinci Dersi hatırlamalıyız:
...
![layeredGames](../../../static/img/agoric/images/layeredGames.png)
...
## Recommended Papers
* [Reasoning about Risk and Trust in an Open Word](https://agoric.com/assets/pdf/papers/reasoning-about-risk-and-trust-in-an-open-world.pdf) 
* [Distributed Electronic Rights in JavaScript](https://agoric.com/assets/pdf/papers/distributed-electronic-rights-in-javascript.pdf) 
* [The digital path](https://agoric.com/assets/pdf/papers/digital-path.pdf)

## Resources
[1] https://www.youtube.com/watch?v=iyuo0ymTt4g 
...
[3] https://github.com/Agoric/agoric-sdk/blob/master/packages/ERTP/NEWS.md 
[4] https://github.com/Agoric/documentation/issues/360 
[5] https://github.com/Agoric/agoric-sdk/issues/81 
[6] https://agoric.com/wp-content/uploads/2022/08/Agoric-White-Paper-v1.1.pdf 
[7] https://docs.agoric.com/guides/js-programming/#vats-the-unit-of-synchrony 
[8] https://github.com/Agoric/agoric-sdk/blob/master/packages/zoe/docs/zoe-zcf.md 
[9] https://docs.agoric.com/reference/zoe-api/zoe.html#e-zoe-startinstance-installation-issuerkeywordrecord-terms-privateargs 
