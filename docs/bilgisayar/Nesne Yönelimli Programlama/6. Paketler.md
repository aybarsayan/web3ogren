...
Yukarıdaki örnekte, java.util paketindeki Date sınıfı, import anahtar kelimesi kullanılarak MyClass sınıfına dahil edilir. Ardından tarih adlı bir değişkene atanır ve ekrana yazdırılır.
